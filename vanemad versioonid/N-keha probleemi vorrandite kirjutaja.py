...
def uuenda_algmoistete_loend():#siin muuta, mõisted mida antud mudeli puhul valida ei saa halliks.
    hargnevad_algmoisted = ["Eukleidiline ruum", "konstandid", 'Aegruum', "ühikud"]
    algmoisted=[("Eukleidiline ruum.sirgjoon","PROOV1","PROOV2"), ("mass","PROOV1","PROOV2"), ("jõud","PROOV1","PROOV2"), ("elektrilaeng","PROOV1","PROOV2"), ("kiirus","PROOV1","PROOV2"), ("kiirendus","PROOV1","PROOV2"), ("punktmasslaeng","PROOV1","PROOV2"),
("konstandid.c valguskiirus","PROOV1","PROOV2"), ("konstandid.ε_E vaakumi dielektriline labitavus",r"1/(4\cdot \pi \cdot k_E)",r"1/(4\cdot \pi \cdot ε_G)"),
("konstandid.ε_G vaakumi digravitatsiooniline labitavus",r"1/(4\cdot \pi \cdot k_G)",r"1/(4\cdot \pi \cdot ε_G)"), ("konstandid.k_E koulombi","PROOV1","PROOV2"),
("konstandid.k_G gravitatsiooni","PROOV1","PROOV2"), ("konstandid.elektrimagnetiline läbitavus","PROOV1","PROOV2"), ("konstandid.gravitimagnetiline läbitavus","PROOV1","PROOV2"),
("Aegruum.aegruumi_algmoiste","PROOV1","PROOV2"), ("ühikud.SI","PROOV1","PROOV2")]
    for hargnev_algmoiste in hargnevad_algmoisted:
        moistete_loend.hlist.add(hargnev_algmoiste, text=hargnev_algmoiste)
    for algmoiste in algmoisted:
        moistete_loend.hlist.add(algmoiste[0], text=algmoiste[0][algmoiste[0].find(".")+1:])
        moistete_loend.setstatus(algmoiste[0], "off")
...
def kuva_algmoiste_info(algmoiste):
    ...
    print(algmoiste)
    vaadatava_algmoiste_kirjeldus.insert(END,(algmoiste[algmoiste.find(".")+1:]).upper()+"\n\n")
    vaadatava_algmoiste_kirjeldus.config(state=DISABLED)
    vaheta_algmoisteid()
def kirjuta_mudeli_valiku_vorrandid(*args):
    seoste_lahter.delete(1.0,"end")
...
seoste_lahter.bind("<Key>",sisendi_lahter_muudeti)
