...
#leida mingi austsüsteem millesse konvetrides viga võimalikult väike tuleks, näiteks selline kus resimpulss ja massikese on 0. Teha arvutused alles selles süsteemis ja lõpuks ümber konvertida kuvamiseks, siis saab renderdamist ja simuleerimist asünkroonselt teha.
...
#kuna eri nurkade alt ja eri kiirusega taustsüsteemidest vaatamiseks peab mu enda programm renderdama mitte ei saa valmis pöörajat kasutada(sest lorentzi teisendus) tuleks see osa renderusest teha c++is.
ll=[]
